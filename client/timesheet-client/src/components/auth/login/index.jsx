...
const Login = () => {
    ...
    const [email, setEmail] = useState('') //capture user input for login credentials 
    ...
    return (
      <div>
      {/* If the user is already logged in go to home page, else login form displayed */}
      ...
      <main className="login-container">
          <div className="login-card">
              ...
              {/*binds the onSubmit event of the form to the onSubmit function defined in the component */}
              ...
              <div className="separator">
                  <div className="line"></div><div className="or-text">OR</div><div className="line"></div>
              </div>
              <button
                  disabled={isSigningIn}
